...
Use this skill to operate the Social Media Triage Kit with Claude Code.
...
Use the approved browser/session layer or official APIs available in the user's Claude Code environment.
...
If no browser or API access is available, produce a review checklist instead of pretending to triage.
